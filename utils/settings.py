...
def load_settings():
    ...
    defaults = dict(
        ...
        SN_SHOCK_P_REF=None,
        # neutrino transport (lightbulb)
        NEUTRINO_ENABLED=False,
        NEUTRINO_MODEL="lightbulb",
        NEUTRINO_LUM=0.0,
        NEUTRINO_EPS=1.0,
        NEUTRINO_KAPPA=0.0,
        NEUTRINO_ABS_COEFF=0.0,
        NEUTRINO_COOL_COEFF=0.0,
        NEUTRINO_COOL_TEXP=6.0,
        NEUTRINO_R0=0.0,
        NEUTRINO_R1=0.0,
        NEUTRINO_TAU_FLOOR=0.0,
        NEUTRINO_TIME_TAU=0.0,
        NEUTRINO_TIME_T0=0.0,
