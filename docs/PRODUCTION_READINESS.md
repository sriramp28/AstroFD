...
- Improved RMHD primitive recovery for extreme magnetization (cold/hot regimes still show high failure rates; conservative-variable consistency checks now included in stress tests).
