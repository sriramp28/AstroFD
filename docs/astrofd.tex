...
\author{Rangamahishi\thanks{Daniel Guggenheim School of Aerospace Engineering, Georgia Institute of Technology}}
\date{\today}
...
support controlled studies. The current implementation uses fixed
spacetime metrics and parameterized SN-lite heating; these choices allow
rapid iteration and reproducibility but do not replace full radiation
transport or dynamic spacetime evolution. Future work will incorporate
more detailed EOS options, expanded benchmark suites, and more complete
transport models.
