...
\end{align}
{\raggedright where $\Gamma^\alpha_{\mu\nu}$ are the Christoffel symbols.
AstroFD uses analytic fixed metrics: Minkowski, Schwarzschild, and
Kerr--Schild. These provide the background terms used to compute the
sources.\par}
